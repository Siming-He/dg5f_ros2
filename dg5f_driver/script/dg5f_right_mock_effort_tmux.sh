...
SESSION="${DG5F_TMUX_SESSION:-dg5f_right_mock_effort}"
...
tmux new-session -d -s "$SESSION" -n main "$(run_cmd 'ros2 launch dg5f_driver dg5f_right_mock_effort.launch.py')"
...
tmux select-pane -t "$SESSION:main.0" -T "mock effort controller"
